...
" lua require ('nvim-context_vt').setup({})
...
augroup MyColors
    autocmd!
    autocmd ColorScheme ayu call DraculaPMenu()
...
" let ayucolor="dark"
" color ayu
" highlight LineNr ctermfg=LightGrey guifg=LightGrey
...
custom_ayu.normal.a = ayu_mirage.normal.a
custom_ayu.insert.a = ayu_mirage.insert.a
custom_ayu.visual.a = ayu_mirage.visual.a
custom_ayu.replace.a = ayu_mirage.replace.a
]]
...
function! ColorAyu()
    let ayucolor='dark'
    colorscheme ayu
    autocmd ColorScheme * highlight LineNr ctermfg=LightGrey guifg=LightGrey
    autocmd ColorScheme * highlight CursorLineNr ctermfg=White guifg=White
endfunction
...
nmap <leader>tv <C-w>v<C-w>l:terminal<CR>:set nonumber<CR><S-a>
...
nmap \| <leader>w
nmap <leader>ktl :Colors<CR>
nmap <leader>kt1 :call ColorDracula()<CR>
nmap <leader>kt2 :call ColorGithub()<CR>
nmap <leader>kt3 :call ColorAyu()<CR>
nmap <leader>kt4 :call ColorAtom()<CR>
nmap <leader>kt5 :call ColorZazen()<CR>
nmap <silent> <leader>r :w<CR>:so ~/.config/nvim/init.vim<CR>:noh<CR>
